  ...
  return (
    <div>
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex justify-between">
                <div className="text-sm">
                  Soutien à la famille/frais de subsistance
                </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="grid grid-cols-8">
                    ...
                    <div className="text-[16px] col-span-7">
                      ...
                      <span className="text-sm">se terminant en 9755</span>
                    </div>
                  </div>
                  <div className="text-[#378abb] text-sm">ÉDITER</div>
                </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="grid grid-cols-8 gap-2">
                    ...
                    <div className="text-[16px] col-span-7">
                      ...
                      <div className="text-[14px]">+ 237 690556330</div>
                      <div className="text-[14px]">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between text-[14px] border-b border-double border-gray-700">
                  <div>
                    Taux de change <sup>2</sup>
                  </div>
                  <div>1 EUR = 655.9570 XAF</div>
                </div>
                <div className="flex justify-between text-[14px]">
                  <div>Total jusqu'au récepteur</div>
                  <div>6 560,00 FCFA</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="text-[10px] w-[800px] flex flex-col mx-auto py-4 gap-2">
        ...
        <div>
          <sup>3</sup>
          Si vous utilisez une carte de crédit, des frais d'avance
          de fonds de l'émetteur de la carte et des frais d'intérêt connexes
          peuvent s'appliquer. Pour éviter ces frais ou pour obtenir des frais
          réduits, utilisez une carte de débit ou vérifiez d'autres modes de
          paiement.
        </div>
      </div>
    </div>
